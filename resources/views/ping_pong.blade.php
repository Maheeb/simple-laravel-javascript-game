...
<script>
    ...
    function update() {
        ...
        if(collides(ball, p1)) {
            ...
            if(ball.y + ball.r > H) {
                ball.y = H - ball.r;
                var snd = new Audio("backend/sounds/punch.wav");
                snd.play();
                gameOver();
            }
            ...
            if(ball.x + ball.r > W) {
                ...
                var snd = new Audio("backend/sounds/wall.mp3");
                snd.play();
            }
    ...
    function collideAction(ball, p) {
        ...
        if(paddleHit == 1) {
            ...
            var snd = new Audio("backend/sounds/ding.wav");
            snd.play();
        }
    ...
    var config = {
        routes: {
            score_detail: "{!! route('ping-pong-score.detail') !!}",
        }
    };
